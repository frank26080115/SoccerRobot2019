...
#define REFRESH_INTERVAL    10000     // minimum time to refresh servos in microseconds
...
public:
  ...
  void writeTicks(uint16_t value);   // Write pulse width in ticks
  uint32_t getTicks(void);           // Read the current number of ticks for this channel
  #if !defined(ESP8266)
  void setAccel(int value);          // Write acceleration value
  #endif
